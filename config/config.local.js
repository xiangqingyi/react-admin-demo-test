...
let config = {
    ...
    //mongodb配置信息
    mongodb: {
        uri: 'mongodb://10.142.214.88:27017/CivetNodeJSAdmin',
        options: {}
    },
    //redis服务，用来session维持，非必须
    redis: {
        host: '127.0.0.1', // 如 127.0.0.1 配置此项表示启用redis，需保证redis服务已启动
        port: 6379, // 6379
        pass: ''
    },
    //react
    react: {
        host: 'http://localhost:3000/civetadmin/'
    },
    //香信
    CIVET: {
